...
namespace frappe {
    ...
    std::string_view filesystem_type_name(filesystem_type type) noexcept {
        switch (type) {
        case filesystem_type::unknown: return "unknown";
        case filesystem_type::ntfs: return "ntfs";
        case filesystem_type::fat: return "fat";
        case filesystem_type::fat32: return "fat32";
        case filesystem_type::exfat: return "exfat";
        case filesystem_type::refs: return "refs";
        case filesystem_type::ext2: return "ext2";
        case filesystem_type::ext3: return "ext3";
        case filesystem_type::ext4: return "ext4";
        case filesystem_type::xfs: return "xfs";
        case filesystem_type::btrfs: return "btrfs";
        case filesystem_type::zfs: return "zfs";
        case filesystem_type::apfs: return "apfs";
        case filesystem_type::hfs_plus: return "hfs+";
        case filesystem_type::nfs: return "nfs";
        case filesystem_type::smb: return "smb";
        case filesystem_type::cifs: return "cifs";
        case filesystem_type::webdav: return "webdav";
        case filesystem_type::tmpfs: return "tmpfs";
        case filesystem_type::ramfs: return "ramfs";
        case filesystem_type::devfs: return "devfs";
        case filesystem_type::procfs: return "procfs";
        case filesystem_type::sysfs: return "sysfs";
        case filesystem_type::fuse: return "fuse";
        case filesystem_type::overlay: return "overlay";
    ...
    std::string_view storage_location_type_name(storage_location_type type) noexcept {
        switch (type) {
        case storage_location_type::unknown: return "unknown";
        case storage_location_type::local: return "local";
        case storage_location_type::removable: return "removable";
        case storage_location_type::optical: return "optical";
        case storage_location_type::network_share: return "network_share";
        case storage_location_type::network_drive: return "network_drive";
        case storage_location_type::nfs: return "nfs";
        case storage_location_type::cloud: return "cloud";
        case storage_location_type::virtual_fs: return "virtual";
        case storage_location_type::fuse: return "fuse";
        case storage_location_type::loop: return "loop";
        case storage_location_type::ram: return "ram";
        default: return "unknown";
        }
    }
    ...
    result<bool> is_removable_storage(const path& p) noexcept {
        auto type = get_storage_location_type(p);
        if (!type) return std::unexpected(type.error());
        return *type == storage_location_type::removable ||
            *type == storage_location_type::optical;
    }

    result<bool> is_network_storage(const path& p) noexcept {
        auto type = get_storage_location_type(p);
        if (!type) return std::unexpected(type.error());
        return *type == storage_location_type::network_share ||
            *type == storage_location_type::network_drive ||
    ...
    result<bool> is_virtual_storage(const path& p) noexcept {
        auto type = get_storage_location_type(p);
        if (!type) return std::unexpected(type.error());
        return *type == storage_location_type::virtual_fs ||
            *type == storage_location_type::fuse ||
            *type == storage_location_type::ram ||
            *type == storage_location_type::loop;
    }
    ...
    std::string_view network_protocol_name(network_protocol proto) noexcept {
        switch (proto) {
        case network_protocol::unknown: return "unknown";
        case network_protocol::smb: return "smb";
        case network_protocol::smb1: return "smb1";
        case network_protocol::smb2: return "smb2";
        case network_protocol::smb3: return "smb3";
        case network_protocol::nfs: return "nfs";
        case network_protocol::nfs3: return "nfs3";
        case network_protocol::nfs4: return "nfs4";
        case network_protocol::webdav: return "webdav";
        case network_protocol::ftp: return "ftp";
        case network_protocol::sftp: return "sftp";
        case network_protocol::afp: return "afp";
        default: return "unknown";
        }
    }
    ...
    result<bool> is_remote_filesystem(const path& p) noexcept {
        ...
        return *fs_type == filesystem_type::nfs ||
            *fs_type == filesystem_type::smb ||
            *fs_type == filesystem_type::cifs ||
    ...
    std::string_view removable_device_type_name(removable_device_type type) noexcept {
        switch (type) {
        case removable_device_type::unknown: return "unknown";
        case removable_device_type::usb_drive: return "usb_drive";
        case removable_device_type::usb_stick: return "usb_stick";
        case removable_device_type::sd_card: return "sd_card";
        case removable_device_type::cf_card: return "cf_card";
        case removable_device_type::external_hdd: return "external_hdd";
        case removable_device_type::external_ssd: return "external_ssd";
        case removable_device_type::optical: return "optical";
        case removable_device_type::floppy: return "floppy";
        case removable_device_type::mtp: return "mtp";
        case removable_device_type::ptp: return "ptp";
        default: return "unknown";
        }
    }
    ...
    result<std::vector<removable_device_info>> list_card_readers() noexcept {
        ...
        for (const auto& d : *all) {
            if (d.device_type == removable_device_type::sd_card ||
                d.device_type == removable_device_type::cf_card) {
                readers.push_back(d);
            }
        }
        return readers;
    ...
    std::string_view device_status_name(device_status status) noexcept {
        switch (status) {
        case device_status::unknown: return "unknown";
        case device_status::ready: return "ready";
        case device_status::not_ready: return "not_ready";
        case device_status::no_media: return "no_media";
        case device_status::error: return "error";
        case device_status::ejecting: return "ejecting";
        case device_status::busy: return "busy";
        default: return "unknown";
        }
    }
    ...
    std::string_view cloud_provider_name(cloud_provider provider) noexcept {
        switch (provider) {
        case cloud_provider::unknown: return "unknown";
        case cloud_provider::onedrive: return "onedrive";
        case cloud_provider::google_drive: return "google_drive";
        case cloud_provider::dropbox: return "dropbox";
        case cloud_provider::icloud: return "icloud";
        case cloud_provider::box: return "box";
        case cloud_provider::amazon_drive: return "amazon_drive";
        case cloud_provider::nextcloud: return "nextcloud";
        case cloud_provider::owncloud: return "owncloud";
        default: return "unknown";
        }
    }
    ...
    std::string_view virtual_fs_type_name(virtual_fs_type type) noexcept {
        switch (type) {
        case virtual_fs_type::unknown: return "unknown";
        case virtual_fs_type::fuse: return "fuse";
        case virtual_fs_type::winfsp: return "winfsp";
        case virtual_fs_type::dokan: return "dokan";
        case virtual_fs_type::overlay: return "overlay";
        case virtual_fs_type::unionfs: return "unionfs";
        case virtual_fs_type::bindfs: return "bindfs";
        case virtual_fs_type::sshfs: return "sshfs";
        case virtual_fs_type::encfs: return "encfs";
        case virtual_fs_type::veracrypt: return "veracrypt";
        case virtual_fs_type::loop: return "loop";
        case virtual_fs_type::tmpfs: return "tmpfs";
        case virtual_fs_type::ramfs: return "ramfs";
        case virtual_fs_type::procfs: return "procfs";
        case virtual_fs_type::sysfs: return "sysfs";
        default: return "unknown";
        }
    }
