...
std::string_view watch_event_type_name(watch_event_type type) noexcept {
    switch (type) {
        case watch_event_type::added: return "added";
        case watch_event_type::modified: return "modified";
        case watch_event_type::removed: return "removed";
        case watch_event_type::renamed: return "renamed";
        case watch_event_type::attributes: return "attributes";
        case watch_event_type::error: return "error";
...
file_watcher::file_watcher(watch_options options)
