...
namespace frappe {
    ...
    namespace {
        ...
        const std::vector<magic_signature>& get_magic_signatures() {
            static const std::vector<magic_signature> signatures = {
                ...
                {{0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A}, 0, file_category::image, "image/png", "PNG image", ".png"},
                ...
                {{0x52, 0x61, 0x72, 0x21, 0x1A, 0x07}, 0, file_category::archive, "application/vnd.rar", "RAR archive", ".rar"},
                {{0x37, 0x7A, 0xBC, 0xAF, 0x27, 0x1C}, 0, file_category::archive, "application/x-7z-compressed", "7-Zip archive", ".7z"},
                ...
                {{0xFD, 0x37, 0x7A, 0x58, 0x5A, 0x00}, 0, file_category::archive, "application/x-xz", "XZ archive", ".xz"},

                // Documents
                {{0x25, 0x50, 0x44, 0x46}, 0, file_category::document, "application/pdf", "PDF document", ".pdf"},
                {{0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1}, 0, file_category::document, "application/msword", "Microsoft Office document", ".doc"},

                // Executables
                {{0x4D, 0x5A}, 0, file_category::executable, "application/x-msdownload", "Windows executable", ".exe"},
                {{0x7F, 0x45, 0x4C, 0x46}, 0, file_category::executable, "application/x-executable", "ELF executable", ""},
                {{0xCF, 0xFA, 0xED, 0xFE}, 0, file_category::executable, "application/x-mach-binary", "Mach-O executable (32-bit)", ""},
                {{0xCE, 0xFA, 0xED, 0xFE}, 0, file_category::executable, "application/x-mach-binary", "Mach-O executable (64-bit)", ""},
    ...
    std::string_view file_category_name(file_category cat) noexcept {
        switch (cat) {
        case file_category::unknown: return "unknown";
        case file_category::text: return "text";
        case file_category::binary: return "binary";
        case file_category::image: return "image";
        case file_category::audio: return "audio";
        case file_category::video: return "video";
        case file_category::archive: return "archive";
        case file_category::document: return "document";
        case file_category::executable: return "executable";
        case file_category::script: return "script";
        case file_category::data: return "data";
