...
std::string_view partition_table_type_name(partition_table_type type) noexcept {
    switch (type) {
        case partition_table_type::mbr: return "mbr";
        case partition_table_type::gpt: return "gpt";
        case partition_table_type::apm: return "apm";
        case partition_table_type::bsd: return "bsd";
        case partition_table_type::sun: return "sun";
...
std::string_view partition_type_name(partition_type type) noexcept {
    switch (type) {
        case partition_type::efi_system: return "efi_system";
        case partition_type::bios_boot: return "bios_boot";
        case partition_type::microsoft_reserved: return "microsoft_reserved";
        case partition_type::microsoft_basic_data: return "microsoft_basic_data";
        case partition_type::microsoft_ldm_metadata: return "microsoft_ldm_metadata";
        case partition_type::microsoft_ldm_data: return "microsoft_ldm_data";
        case partition_type::microsoft_recovery: return "microsoft_recovery";
        case partition_type::microsoft_storage_spaces: return "microsoft_storage_spaces";
        case partition_type::linux_filesystem: return "linux_filesystem";
        case partition_type::linux_swap: return "linux_swap";
        case partition_type::linux_lvm: return "linux_lvm";
        case partition_type::linux_raid: return "linux_raid";
        case partition_type::linux_home: return "linux_home";
        case partition_type::linux_root_x86: return "linux_root_x86";
        case partition_type::linux_root_x86_64: return "linux_root_x86_64";
        case partition_type::linux_root_arm: return "linux_root_arm";
        case partition_type::linux_root_arm64: return "linux_root_arm64";
        case partition_type::apple_hfs: return "apple_hfs";
        case partition_type::apple_apfs: return "apple_apfs";
        case partition_type::apple_boot: return "apple_boot";
        case partition_type::apple_raid: return "apple_raid";
        case partition_type::apple_label: return "apple_label";
        case partition_type::freebsd_boot: return "freebsd_boot";
        case partition_type::freebsd_data: return "freebsd_data";
        case partition_type::freebsd_swap: return "freebsd_swap";
        case partition_type::solaris_root: return "solaris_root";
        case partition_type::solaris_swap: return "solaris_swap";
        default: return "unknown";
    }
}
...
std::string_view disk_type_name(disk_type type) noexcept {
    switch (type) {
        case disk_type::hdd: return "hdd";
        case disk_type::ssd: return "ssd";
        case disk_type::nvme: return "nvme";
        case disk_type::usb: return "usb";
        case disk_type::optical: return "optical";
        case disk_type::floppy: return "floppy";
        case disk_type::virtual_disk: return "virtual_disk";
        case disk_type::ram_disk: return "ram_disk";
        case disk_type::network: return "network";
        default: return "unknown";
    }
}
...
std::string_view disk_bus_type_name(disk_bus_type type) noexcept {
    switch (type) {
        case disk_bus_type::ata: return "ata";
        case disk_bus_type::sata: return "sata";
        case disk_bus_type::scsi: return "scsi";
        case disk_bus_type::sas: return "sas";
        case disk_bus_type::usb: return "usb";
        case disk_bus_type::nvme: return "nvme";
        case disk_bus_type::pcie: return "pcie";
        case disk_bus_type::thunderbolt: return "thunderbolt";
        case disk_bus_type::firewire: return "firewire";
        case disk_bus_type::virtual_bus: return "virtual";
        case disk_bus_type::mmc: return "mmc";
        case disk_bus_type::raid: return "raid";
        default: return "unknown";
    }
}
...
result<bool> is_system_partition(const path& p) noexcept {
    ...
    return info->type == partition_type::efi_system ||
           info->type == partition_type::microsoft_reserved ||
...
result<bool> is_boot_partition(const path& p) noexcept {
    ...
    return info->is_bootable || info->is_active ||
           info->type == partition_type::efi_system ||
...
std::string_view smart_status_name(smart_status status) noexcept {
    switch (status) {
        case smart_status::good: return "good";
        case smart_status::warning: return "warning";
        case smart_status::critical: return "critical";
        case smart_status::failing: return "failing";
        default: return "unknown";
    }
}
...
std::string_view storage_pool_type_name(storage_pool_type type) noexcept {
    switch (type) {
        case storage_pool_type::lvm: return "lvm";
        case storage_pool_type::zfs: return "zfs";
        case storage_pool_type::btrfs: return "btrfs";
        case storage_pool_type::mdraid: return "mdraid";
        case storage_pool_type::storage_spaces: return "storage_spaces";
        case storage_pool_type::apfs_container: return "apfs_container";
        default: return "unknown";
    }
}
...
std::string_view raid_level_name(raid_level level) noexcept {
    switch (level) {
        case raid_level::raid0: return "raid0";
        case raid_level::raid1: return "raid1";
        case raid_level::raid5: return "raid5";
        case raid_level::raid6: return "raid6";
        case raid_level::raid10: return "raid10";
        case raid_level::raid01: return "raid01";
        case raid_level::jbod: return "jbod";
        case raid_level::single: return "single";
        default: return "unknown";
    }
}
...
std::string_view raid_state_name(raid_state state) noexcept {
    switch (state) {
        case raid_state::active: return "active";
        case raid_state::degraded: return "degraded";
        case raid_state::rebuilding: return "rebuilding";
        case raid_state::resyncing: return "resyncing";
        case raid_state::failed: return "failed";
        case raid_state::inactive: return "inactive";
        default: return "unknown";
    }
}
...
std::string_view virtual_disk_type_name(virtual_disk_type type) noexcept {
    switch (type) {
        case virtual_disk_type::vhd: return "vhd";
        case virtual_disk_type::vhdx: return "vhdx";
        case virtual_disk_type::vmdk: return "vmdk";
        case virtual_disk_type::vdi: return "vdi";
        case virtual_disk_type::qcow: return "qcow";
        case virtual_disk_type::qcow2: return "qcow2";
        case virtual_disk_type::raw: return "raw";
        case virtual_disk_type::iso: return "iso";
        case virtual_disk_type::dmg: return "dmg";
        case virtual_disk_type::sparse: return "sparse";
        case virtual_disk_type::img: return "img";
        default: return "unknown";
    }
}
