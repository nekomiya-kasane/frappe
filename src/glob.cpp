...
void glob_impl(const path &base_path, std::string_view pattern, std::vector<path> &results, bool recursive = false) {
...
glob_range::glob_range(const path &base_path, std::string_view pattern) : _base_path(base_path), _pattern(pattern) {}
