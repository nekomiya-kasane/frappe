...
namespace frappe {
    ...
    [[nodiscard]] FRAPPE_API compiled_regex compile_regex(std::string_view pattern,
                                                          regex_options opts = regex_options::none);
    ...
    [[nodiscard]] FRAPPE_API std::optional<path> regex_replace(const path &p, std::string_view pattern,
                                                               std::string_view replacement);
    [[nodiscard]] FRAPPE_API std::optional<std::string> regex_replace(std::string_view text, std::string_view pattern,
                                                                      std::string_view replacement);
    [[nodiscard]] FRAPPE_API std::optional<path> regex_replace(const path &p, const compiled_regex &re,
                                                               std::string_view replacement);
    [[nodiscard]] FRAPPE_API std::optional<std::string> regex_replace(std::string_view text, const compiled_regex &re,
                                                                      std::string_view replacement);
    ...
    struct filter_regex_fn {
        ...
        template <std::ranges::input_range R> friend auto operator|(R &&r, const filter_regex_fn &fn) {
    ...
    struct filter_regex_not_fn {
        ...
        template <std::ranges::input_range R> friend auto operator|(R &&r, const filter_regex_not_fn &fn) {
            return fn(std::forward<R>(r));
        }
    };
