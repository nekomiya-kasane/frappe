...
namespace frappe {
    ...
    [[nodiscard]] FRAPPE_API std::vector<file_entry> traverse_collect(const path &root,
    ...
    [[nodiscard]] FRAPPE_API std::vector<file_entry>
    traverse_parallel(const path &root, const traversal_options &opts = {},
