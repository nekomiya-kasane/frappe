...
namespace frappe {
    ...
    [[nodiscard]] FRAPPE_API void_result set_permissions(const path &p, perms prms,
                                                         perm_options opts = perm_options::replace) noexcept;
    ...
    [[nodiscard]] FRAPPE_API result<bool> check_access(const path &p, std::string_view user_name,
                                                       access_rights rights) noexcept;
    [[nodiscard]] FRAPPE_API result<access_rights> get_effective_rights(const path &p,
    ...
    [[nodiscard]] FRAPPE_API result<security_identifier> lookup_account(std::string_view domain,
