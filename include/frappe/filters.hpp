...
template <typename P1, typename P2> [[nodiscard]] inline auto operator&&(filter_adapter<P1> f1, filter_adapter<P2> f2) {
...
inline const auto empty_files = filter([](const file_entry &e) { return e.type == file_type::regular && e.size == 0; });
