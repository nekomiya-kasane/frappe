...
[[nodiscard]] FRAPPE_API std::vector<path> find(const path& search_path, const find_options& options, std::error_code& ec);
...
namespace literals {
    constexpr std::uintmax_t operator""_B(unsigned long long v) { return v; }
    constexpr std::uintmax_t operator""_KB(unsigned long long v) { return v * 1024; }
    constexpr std::uintmax_t operator""_MB(unsigned long long v) { return v * 1024 * 1024; }
    constexpr std::uintmax_t operator""_GB(unsigned long long v) { return v * 1024 * 1024 * 1024; }
    constexpr std::uintmax_t operator""_TB(unsigned long long v) { return v * 1024ULL * 1024 * 1024 * 1024; }
}
...
struct sort_by_name_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const sort_by_name_fn& fn) {
...
struct sort_by_size_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const sort_by_size_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
struct sort_by_mtime_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const sort_by_mtime_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
struct sort_by_extension_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const sort_by_extension_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
struct take_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const take_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
struct first_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const first_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
struct reverse_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const reverse_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
struct filter_filename_regex_fn {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const filter_filename_regex_fn& fn) {
        return fn(std::forward<R>(r));
    }
};
...
template<std::ranges::input_range R>
[[nodiscard]] std::uintmax_t total_size(R&& r) {
