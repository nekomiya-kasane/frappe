...
[[nodiscard]] FRAPPE_API result<std::optional<partition_info>> get_partition_by_uuid(std::string_view uuid) noexcept;
[[nodiscard]] FRAPPE_API result<std::optional<partition_info>> get_partition_by_label(std::string_view label) noexcept;
