...
struct select_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const select_adapter& s) {
        return s(std::forward<R>(r));
    }
    
private:
    template<typename T, std::size_t... Is>
    auto apply_projections(const T& item, std::index_sequence<Is...>) const {
        return std::make_tuple(std::get<Is>(projections)(item)...);
    }
};

template<typename... Projs>
[[nodiscard]] inline auto select(Projs... projs) {
...
struct map_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const map_adapter& m) {
        return m(std::forward<R>(r));
    }
};

template<typename Func>
[[nodiscard]] inline auto map_to(Func func) {
...
struct flat_map_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const flat_map_adapter& fm) {
        return fm(std::forward<R>(r));
    }
};

template<typename Func>
[[nodiscard]] inline auto flat_map(Func func) {
...
struct filter_map_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const filter_map_adapter& fm) {
        return fm(std::forward<R>(r));
    }
};

template<typename Pred, typename Func>
[[nodiscard]] inline auto filter_map(Pred pred, Func func) {
...
struct zip_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const zip_adapter& z) {
        return z(std::forward<R>(r));
    }
};

template<typename Range2>
[[nodiscard]] inline auto zip_with(Range2&& other) {
...
struct tap_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const tap_adapter& t) {
        return t(std::forward<R>(r));
    }
};

template<typename Func>
[[nodiscard]] inline auto tap(Func func) {
...
struct scan_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const scan_adapter& s) {
        return s(std::forward<R>(r));
    }
};

template<typename Func, typename Init>
[[nodiscard]] inline auto scan(Func func, Init init) {
...
struct reduce_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const reduce_adapter& red) {
        return red(std::forward<R>(r));
    }
};

template<typename Func, typename Init>
[[nodiscard]] inline auto reduce(Func func, Init init) {
...
struct to_vector_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const to_vector_adapter& tv) {
...
struct to_set_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const to_set_adapter& ts) {
...
[[nodiscard]] inline auto to_set_by(Proj proj) {
...
struct to_map_adapter {
    ...
    template<std::ranges::input_range R>
    friend auto operator|(R&& r, const to_map_adapter& tm) {
