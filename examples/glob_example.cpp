...
int main(int argc, char* argv[]) {
    ...
    std::cout << "fnmatch('file.txt', '*.txt') = " 
              << (frappe::fnmatch("file.txt", "*.txt") ? "true" : "false") << std::endl;
    std::cout << "fnmatch('file.txt', '*.log') = " 
              << (frappe::fnmatch("file.txt", "*.log") ? "true" : "false") << std::endl;
